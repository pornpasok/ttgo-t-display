...
const char* ssid     = "SookYenFarm";       ///EDIIIT
const char* password = "0863741677"; //EDI8IT
String town="Chanthaburi";              //EDDIT
String Country="TH";                //EDDIT
const String endpoint = "http://api.openweathermap.org/data/2.5/weather?q="+town+","+Country+"&units=metric&APPID=";
const String key = "14d2bcc75af68c7074198d3d100bea39"; /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
